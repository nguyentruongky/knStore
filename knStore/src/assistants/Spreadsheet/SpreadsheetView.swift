...
public class SpreadsheetView: UIView {
    ...
    func setupView(controller: SpreadsheetViewDataSource & SpreadsheetViewDelegate) {
        ...
        register(HeaderCell.self, forCellWithReuseIdentifier: String(describing: HeaderCell.self))
        register(TextCell.self, forCellWithReuseIdentifier: String(describing: TextCell.self))
    }
